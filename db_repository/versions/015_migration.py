...
pre_meta = MetaData()
post_meta = MetaData()
phonenumber = Table('phonenumber', post_meta,
...
def upgrade(migrate_engine):
    ...
    post_meta.tables['phonenumber'].create()
    pre_meta.tables['emergency_contact'].columns['phone_number'].drop()
    post_meta.tables['emergency_contact'].columns['phone_number_id'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    post_meta.tables['phonenumber'].drop()
    pre_meta.tables['emergency_contact'].columns['phone_number'].create()
    post_meta.tables['emergency_contact'].columns['phone_number_id'].drop()
